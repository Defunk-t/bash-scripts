...
alias yt-dlp='yt-dlp --embed-metadata --write-info-json --cookies-from-browser firefox --user-agent "Mozilla/5.0 (X11; Linux x86_64; rv:121.0) Gecko/20100101 Firefox/121.0" -o "/mnt/nas/Anon/Downloads/%(upload_date)s_%(title)s_%(id)s.%(ext)s"'
